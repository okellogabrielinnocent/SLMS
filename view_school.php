                     ...
                     <div class="row-fluid">
                        ...
                        <div  id="block_bg" class="block">
							...
							<div class="span6">
								...
								IP Adress: <strong><?php echo $row['pub_ip_add']; ?></strong><hr>
								ISP Provider: <strong><?php echo $row['isp_id']; ?></strong><hr>
							</div>
							<div class="span5">
								<?php
							...
							<div class="span12">
								...
								<tbody>
								<?php
								$query3 = mysqli_query($connection,"select * from isp_det where isp_id = '$get_id'")or die(mysqli_error());
